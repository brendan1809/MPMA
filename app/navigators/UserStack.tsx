...
export const UserStack = () => {
  return (
    ...
    >
      ...
      {/* <Stack.Screen name="StudentSubmissionDone" component={StuSubmissionDoneScreen} options={{ title: "Student Submission"}}/> */}
      {/* <Stack.Screen name="StuProfile" component={StuProfileScreen} options={{ title: "Profile Settings"}}/> */}
      <Stack.Screen name="StuEditProfile" component={StuEditProfileScreen} options={{ title: "Edit Profile"}}/>
      {/* <Stack.Screen name="TC" component={TCScreen} options={{ title: "Terms & Conditions"}}/> */}
